...
class Pokemon:
    def __init__(self, typee, barreDeVie, nom, defense, attack):
        self.type = typee #le type du Pokemon
...
class PokemonSauvage(Pokemon):
    def __init__(self, nom, Coord, type1, type2, barreDeVie, defense, attack):
        self.Coord = Coord
        self.type1 = type1
        self.type2 = type2
...
class PokemonDresseur(Pokemon):
    def __init__(self, nom, type1, type2, barreDeVie, defense, attack):
        self.nom = nom
        self.type1 = type1
        self.type2 = type2
        self.barreDeVie = barreDeVie
...
class Pokemons(PokemonSauvage):
    def __init__(self, nom):
        ...
        for i in range(0, 151):
            ...
            self.pokemons[nomPokemon[i]] = PokemonSauvage(nom, Coord, type1, type2, hp, defense)
